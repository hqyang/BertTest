...
def test_bad_case(model):
    tt00 = '''
    e生宝是个很不错的保险。也不怕掉“眉”-诗蒂娅眉膏。✨眉笔对于我来说是非常重要的，我现在出门肯定不能遗漏的步骤就是眉毛，而且进入夏季，没有定妆，就必须带着补眉毛的产品。。✨入手了两款不同色系的眉膏，一款是EB03，深棕色，这款眉膏是上下两层的那种，上面是填充的眉粉，下面是眉膏。深棕色很适合日常。EB04，深灰褐，灰褐色这个颜色很妙，和我本身眉毛颜色很相近，防水防汗易上色，好勾勒眉形，小小的也便于携带，最近也爱上了眉膏化眉，保持也比较久。。#逆袭小仙女#。#理发前后#。#这不是化妆是魔法#。#我怎么这么好看#
    '''
    extract_CWSPOS(model, tt00)
