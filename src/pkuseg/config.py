...
# -*- coding: utf-8 -*-
"""
Created on at 22:31 2019-02-02 
@author: haiqinyang

Feature: copy from https://github.com/lancopku/pkuseg-python/blob/master/pkuseg/config.py
...
class Config:
    ...
    delimInFeature = "."
    B = "B"
    num = "0123456789.一二三四五六七八九十千万亿兆零１２３４５６７８９０％"
